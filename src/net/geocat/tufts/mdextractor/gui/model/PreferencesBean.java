...
public class PreferencesBean extends Model {
	...
	public void setOrganization(String organization) {
		...
		firePropertyChange(ORGANIZATION_PROPERTY, oldOrganization, this.organization);
	}
	/**
	 * @return the email
	 */
	...
	/**
	 * @param defaultProjection the defaultProjection to set
	 */
	public void setDefaultProjection(String defaultProjection) {
		...
		firePropertyChange(DEFAULT_PROYECTION_PROPERTY, oldProjection, this.defaultProjection);
	}
	/**
	 * @return the minx
	 */
