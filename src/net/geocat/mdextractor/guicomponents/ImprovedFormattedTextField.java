...
public class ImprovedFormattedTextField extends JFormattedTextField {
	...
	private static final long serialVersionUID = -3022903156708289107L;
	...
	public ImprovedFormattedTextField(Format aFormat) {
		// use a DoubleFormatter as we do not want to accept user input which is
		// partially valid
		super(new DoubleFormatter(aFormat));
