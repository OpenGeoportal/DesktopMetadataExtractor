...
package tufts_metadata_generator.start_0_1;
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				tufts_metadata_generator.cleanup_job_0_1.Cleanup_job childJob_tRunJob_1 = new tufts_metadata_generator.cleanup_job_0_1.Cleanup_job();
				// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1
					...
					parentContextMap_tRunJob_3.put("mdName", context.mdName);

					parentContextMap_tRunJob_3.put("mdOrganization",
					...
					tufts_metadata_generator.rasterjob_0_1.RasterJob childJob_tRunJob_3 = new tufts_metadata_generator.rasterjob_0_1.RasterJob();
					// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				for (int i_tFileList_4 = 0; i_tFileList_4 < list_tFileList_4
					...
					parentContextMap_tRunJob_2.put("mdName", context.mdName);

					parentContextMap_tRunJob_2.put("mdOrganization",
							context.mdOrganization);
					...
					tufts_metadata_generator.vectorjob_0_1.VectorJob childJob_tRunJob_2 = new tufts_metadata_generator.vectorjob_0_1.VectorJob();
					// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Start.class.getClassLoader()
					.getResourceAsStream(
							"tufts_metadata_generator/start_0_1/contexts/"
...
/************************************************************************************************
 * 64403 characters generated by Talend Open Studio for Data Integration on the
